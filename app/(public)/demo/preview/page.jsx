...
import { BarChart3, CheckCircle, Database, Gauge, Rocket, Shield, Star, Zap } from "lucide-react"
import Image from "next/image"

export default function RecruitlyPreviewCard({
	title = "Full Stack Recruitment Hiring Management Next.js Application",
	landingImage = "/images/demo/landing/17.png",
	cardBg = "/images/bg/3.jpg",
	features = [
		"Multi-Role User Management",
		"Responsive and Accessible UI",
		"Secure Payment and Media Integration",
		"Advanced Job and Profile Customization",
	...
	return (
		<div className="flex flex-col items-center justify-center h-full space-y-5">
			...
			>
				...
				<div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-primary/15 to-primary/10" />
									...
									return (
										<div key={i} className="flex items-start gap-3 group">
											<div className="flex-shrink-0 mt-0">
												<Icon className="w-4 h-4 text-primary group-hover:text-primary/80 transition-colors duration-200" />
											</div>
											<p className="text-xs text-slate-300 leading-relaxed group-hover:text-slate-200 transition-colors duration-200">
												{feature}
											</p>
										</div>
									)
			...
			>
				{/* Background glow */}
				<div className="absolute inset-0 rounded-lg bg-primary/25 blur-2xl -z-10" />
				...
				<div className="text-sm font-semibold select-none leading-none text-center">
					Recruitly
				</div>
			</div>
		</div>
