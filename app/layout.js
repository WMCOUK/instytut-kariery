...
export const metadata = {
	...
	description: "Instytut Kariery to nowoczesny portal pracy łączący pracodawców z najlepszymi kandydatami. Znajdź oferty pracy, rekruterów i możliwości kariery.",
	icons: {
		icon: [
