...
import DeleteCandidateEducationDialog from "../elements/DeleteCandidateEducationDialog"
...
function CandidateEducationTable({ data = [], totalPage, page, isLoading }) {
	...
	// Open dialog with given attribute info
	...
	return (
		<div className="w-full">
			...
			<DeleteCandidateEducationDialog
	...
	return (
		<DropdownMenu>
			...
			<DropdownMenuContent align="end">
				<Link href={`/candidate/attributes/education/${attribute?.slug}`}>
					<DropdownMenuItem>
						<ReceiptText className="h-4 w-4" /> Details
					</DropdownMenuItem>
				</Link>
				<Link href={`/candidate/attributes/education/edit/${attribute?.slug}`}>
					<DropdownMenuItem>
