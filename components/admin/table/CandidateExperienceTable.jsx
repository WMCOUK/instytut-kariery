...
import DeleteCandidateExperienceDialog from "../elements/DeleteCandidateExperienceDialog"
...
const columns = [
	...
	},
	{
		...
		enableHiding: false,
		cell: ({ row }) => <RowActions attribute={row.original} />,
	},
]

function CandidateExperienceTable({ data = [], totalPage, page, isLoading }) {
	...
	const table = useReactTable({
		data,
		columns: getColumns(openDeleteDialog),
	...
	return (
		<div className="w-full">
			...
			<DeleteCandidateExperienceDialog
...
function getColumns(openDeleteDialog) {
	return [
		// {
		// 	accessorKey: "image",
		// 	header: ({ column }) => <DataTableColumnHeader column={column} title="Image" />,
	...
	return (
		<DropdownMenu>
			...
			<DropdownMenuContent align="end">
				<Link href={`/candidate/attributes/experience/${attribute?.slug}`}>
					<DropdownMenuItem>
						<ReceiptText className="h-4 w-4" /> Details
					</DropdownMenuItem>
				</Link>
				<Link href={`/candidate/attributes/experience/edit/${attribute?.slug}`}>
					<DropdownMenuItem>
