					...
					<div className="team1-grid mt-10">
						<div className="flex flex-wrap -mx-5">
							<div className="w-1/2 lg:w-1/4 px-5 mb-12">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center  rounded shadow animated border border-gray-100 hover:border-gray-200" data-wow-delay=".1s">
							...
							<div className="w-1/2 lg:w-1/4 px-5 mb-12">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center  rounded shadow animated border border-gray-100 hover:border-gray-200" data-wow-delay=".3s">
							...
							<div className="w-1/2 lg:w-1/4 px-5 mb-12">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center  rounded shadow animated border border-gray-100 hover:border-gray-200" data-wow-delay=".5s">
							...
							<div className="w-1/2 lg:w-1/4 px-5 mb-12">
								<div className="hover-up-5 pt-8 pb-8 px-4 text-center  rounded shadow animated border border-gray-100 hover:border-gray-200" data-wow-delay=".7s">
