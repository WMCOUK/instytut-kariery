import { cn } from "@/utils" // Assuming cn is a utility function for classnames
...
const TagInput = ({ value, onChange, className, ...props }) => {
	...
	return (
		<div
			className={cn(
				"flex flex-wrap items-center gap-2 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-within:ring-0 focus-within:ring-ring focus-within:ring-offset-0",
				className
			)}
		>
			{/* Display Tags */}
